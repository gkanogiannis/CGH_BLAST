/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.tblastx.types.AppConfigType
 *
...
public class AppConfigType  implements java.io.Serializable {
    private ciat.cgh.blast.ws.tblastx.types.AppMetadataType metadata;
    ...
    public AppConfigType(
           ciat.cgh.blast.ws.tblastx.types.AppMetadataType metadata,
     ...
     * @return metadata
     */
    public ciat.cgh.blast.ws.tblastx.types.AppMetadataType getMetadata() {
        return metadata;
    }
     ...
     * @param metadata
     */
    public void setMetadata(ciat.cgh.blast.ws.tblastx.types.AppMetadataType metadata) {
        this.metadata = metadata;
    }
