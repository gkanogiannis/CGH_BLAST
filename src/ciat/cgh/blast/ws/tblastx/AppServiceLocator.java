/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.tblastx.AppServiceLocator
 *
...
public class AppServiceLocator extends org.apache.axis.client.Service implements ciat.cgh.blast.ws.tblastx.AppService {
    ...
    private java.lang.String AppServicePort_address = "http://172.22.55.12:8080/opal2/services/tblastx";
    ...
    public ciat.cgh.blast.ws.tblastx.AppServicePortType getAppServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ciat.cgh.blast.ws.tblastx.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.tblastx.AppServicePortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ciat.cgh.blast.ws.tblastx.AppServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ciat.cgh.blast.ws.tblastx.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.tblastx.AppServicePortSoapBindingStub(new java.net.URL(AppServicePort_address), this);
                _stub.setPortName(getAppServicePortWSDDServiceName());
                return _stub;
            }
        }
