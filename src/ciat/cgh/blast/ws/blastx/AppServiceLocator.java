/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastx.AppServiceLocator
 *
...
public class AppServiceLocator extends org.apache.axis.client.Service implements ciat.cgh.blast.ws.blastx.AppService {
    ...
    private java.lang.String AppServicePort_address = "http://172.22.55.12:8080/opal2/services/blastx";
    ...
    public ciat.cgh.blast.ws.blastx.AppServicePortType getAppServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public ciat.cgh.blast.ws.blastx.AppServicePortType getAppServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ciat.cgh.blast.ws.blastx.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.blastx.AppServicePortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ciat.cgh.blast.ws.blastx.AppServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ciat.cgh.blast.ws.blastx.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.blastx.AppServicePortSoapBindingStub(new java.net.URL(AppServicePort_address), this);
                _stub.setPortName(getAppServicePortWSDDServiceName());
                return _stub;
            }
        }
