/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastx.types.AppMetadataType
 *
...
public class AppMetadataType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastx.types.ArgumentsType types;
    ...
    public AppMetadataType(
           ...
           ciat.cgh.blast.ws.blastx.types.ArgumentsType types,
     ...
     * @return types
     */
    public ciat.cgh.blast.ws.blastx.types.ArgumentsType getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(ciat.cgh.blast.ws.blastx.types.ArgumentsType types) {
        this.types = types;
    }
