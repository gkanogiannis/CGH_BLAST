/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastx.types.AppConfigType
 *
...
public class AppConfigType  implements java.io.Serializable {
    private ciat.cgh.blast.ws.blastx.types.AppMetadataType metadata;
    ...
    public AppConfigType(
           ciat.cgh.blast.ws.blastx.types.AppMetadataType metadata,
     ...
     * @return metadata
     */
    public ciat.cgh.blast.ws.blastx.types.AppMetadataType getMetadata() {
        return metadata;
    }
     ...
     * @param metadata
     */
    public void setMetadata(ciat.cgh.blast.ws.blastx.types.AppMetadataType metadata) {
        this.metadata = metadata;
    }
