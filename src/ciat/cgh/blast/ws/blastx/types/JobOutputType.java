/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastx.types.JobOutputType
 *
...
public class JobOutputType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastx.types.OutputFileType[] outputFile;
    ...
    public JobOutputType(
           ...
           ciat.cgh.blast.ws.blastx.types.OutputFileType[] outputFile) {
           this.stdOut = stdOut;
           this.stdErr = stdErr;
     ...
     * @return outputFile
     */
    public ciat.cgh.blast.ws.blastx.types.OutputFileType[] getOutputFile() {
        return outputFile;
    }
     ...
     * @param outputFile
     */
    public void setOutputFile(ciat.cgh.blast.ws.blastx.types.OutputFileType[] outputFile) {
        this.outputFile = outputFile;
    }

    public ciat.cgh.blast.ws.blastx.types.OutputFileType getOutputFile(int i) {
        return this.outputFile[i];
    }

    public void setOutputFile(int i, ciat.cgh.blast.ws.blastx.types.OutputFileType _value) {
