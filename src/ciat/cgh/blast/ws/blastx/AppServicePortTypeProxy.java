/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastx.AppServicePortTypeProxy
 *
...
public class AppServicePortTypeProxy implements ciat.cgh.blast.ws.blastx.AppServicePortType {
  private String _endpoint = null;
  private ciat.cgh.blast.ws.blastx.AppServicePortType appServicePortType = null;
  ...
  private void _initAppServicePortTypeProxy() {
    try {
      appServicePortType = (new ciat.cgh.blast.ws.blastx.AppServiceLocator()).getAppServicePort();
  ...
  public ciat.cgh.blast.ws.blastx.AppServicePortType getAppServicePortType() {
    if (appServicePortType == null)
      _initAppServicePortTypeProxy();
