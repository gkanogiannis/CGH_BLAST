/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastp.types.ParamsArrayType
 *
...
public class ParamsArrayType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastp.types.ParamsType[] param;
    ...
    public ParamsArrayType(
           ...
           ciat.cgh.blast.ws.blastp.types.ParamsType[] param) {
     ...
     * @return param
     */
    public ciat.cgh.blast.ws.blastp.types.ParamsType[] getParam() {
        return param;
    }
     ...
     * @param param
     */
    public void setParam(ciat.cgh.blast.ws.blastp.types.ParamsType[] param) {
        this.param = param;
    }

    public ciat.cgh.blast.ws.blastp.types.ParamsType getParam(int i) {
        return this.param[i];
    }

    public void setParam(int i, ciat.cgh.blast.ws.blastp.types.ParamsType _value) {
        this.param[i] = _value;
    }
