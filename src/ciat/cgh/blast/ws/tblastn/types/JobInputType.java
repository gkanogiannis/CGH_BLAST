/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.tblastn.types.JobInputType
 *
...
public class JobInputType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.tblastn.types.InputFileType[] inputFile;
    ...
    public JobInputType(
           ...
           ciat.cgh.blast.ws.tblastn.types.InputFileType[] inputFile,
     ...
     * @return inputFile
     */
    public ciat.cgh.blast.ws.tblastn.types.InputFileType[] getInputFile() {
        return inputFile;
    }
     ...
     * @param inputFile
     */
    public void setInputFile(ciat.cgh.blast.ws.tblastn.types.InputFileType[] inputFile) {
        this.inputFile = inputFile;
    }

    public ciat.cgh.blast.ws.tblastn.types.InputFileType getInputFile(int i) {
        return this.inputFile[i];
    }

    public void setInputFile(int i, ciat.cgh.blast.ws.tblastn.types.InputFileType _value) {
