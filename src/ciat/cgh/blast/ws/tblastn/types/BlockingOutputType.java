/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.tblastn.types.BlockingOutputType
 *
...
public class BlockingOutputType  implements java.io.Serializable {
    private ciat.cgh.blast.ws.tblastn.types.StatusOutputType status;

    private ciat.cgh.blast.ws.tblastn.types.JobOutputType jobOut;

    public BlockingOutputType() {
    }

    public BlockingOutputType(
           ciat.cgh.blast.ws.tblastn.types.StatusOutputType status,
           ciat.cgh.blast.ws.tblastn.types.JobOutputType jobOut) {
           this.status = status;
           this.jobOut = jobOut;
    }
     ...
     * @return status
     */
    public ciat.cgh.blast.ws.tblastn.types.StatusOutputType getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(ciat.cgh.blast.ws.tblastn.types.StatusOutputType status) {
        this.status = status;
    }
     ...
     * @return jobOut
     */
    public ciat.cgh.blast.ws.tblastn.types.JobOutputType getJobOut() {
        return jobOut;
    }
     ...
     * @param jobOut
     */
    public void setJobOut(ciat.cgh.blast.ws.tblastn.types.JobOutputType jobOut) {
        this.jobOut = jobOut;
    }
