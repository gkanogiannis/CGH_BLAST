/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.tblastn.types.ArgumentsType
 *
...
public class ArgumentsType  implements java.io.Serializable {
    private ciat.cgh.blast.ws.tblastn.types.FlagsType[] flags;

    private ciat.cgh.blast.ws.tblastn.types.ParamsArrayType taggedParams;

    private ciat.cgh.blast.ws.tblastn.types.ParamsArrayType untaggedParams;

    private ciat.cgh.blast.ws.tblastn.types.ImplicitParamsType[] implicitParams;

    private ciat.cgh.blast.ws.tblastn.types.GroupsType[] groups;

    public ArgumentsType() {
    }

    public ArgumentsType(
           ciat.cgh.blast.ws.tblastn.types.FlagsType[] flags,
           ciat.cgh.blast.ws.tblastn.types.ParamsArrayType taggedParams,
           ciat.cgh.blast.ws.tblastn.types.ParamsArrayType untaggedParams,
           ciat.cgh.blast.ws.tblastn.types.ImplicitParamsType[] implicitParams,
           ciat.cgh.blast.ws.tblastn.types.GroupsType[] groups) {
           this.flags = flags;
     ...
     * @return flags
     */
    public ciat.cgh.blast.ws.tblastn.types.FlagsType[] getFlags() {
        return flags;
    }
     ...
     * @param flags
     */
    public void setFlags(ciat.cgh.blast.ws.tblastn.types.FlagsType[] flags) {
        this.flags = flags;
    }
     ...
     * @return taggedParams
     */
    public ciat.cgh.blast.ws.tblastn.types.ParamsArrayType getTaggedParams() {
        return taggedParams;
    }
     ...
     * @param taggedParams
     */
    public void setTaggedParams(ciat.cgh.blast.ws.tblastn.types.ParamsArrayType taggedParams) {
        this.taggedParams = taggedParams;
    }
     ...
     */
    public ciat.cgh.blast.ws.tblastn.types.ParamsArrayType getUntaggedParams() {
        return untaggedParams;
    }
     ...
     */
    public void setUntaggedParams(ciat.cgh.blast.ws.tblastn.types.ParamsArrayType untaggedParams) {
        this.untaggedParams = untaggedParams;
    }
     ...
     */
    public ciat.cgh.blast.ws.tblastn.types.ImplicitParamsType[] getImplicitParams() {
        return implicitParams;
    }
     ...
     */
    public void setImplicitParams(ciat.cgh.blast.ws.tblastn.types.ImplicitParamsType[] implicitParams) {
        this.implicitParams = implicitParams;
    }
     ...
     * @return groups
     */
    public ciat.cgh.blast.ws.tblastn.types.GroupsType[] getGroups() {
        return groups;
    }
     ...
     * @param groups
     */
    public void setGroups(ciat.cgh.blast.ws.tblastn.types.GroupsType[] groups) {
        this.groups = groups;
    }
