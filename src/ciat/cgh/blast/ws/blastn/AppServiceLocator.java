/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastn.AppServiceLocator
 *
...
public class AppServiceLocator extends org.apache.axis.client.Service implements ciat.cgh.blast.ws.blastn.AppService {
    ...
    private java.lang.String AppServicePort_address = "https://172.22.55.12:8443/opal2/services/blastn";
    ...
    public ciat.cgh.blast.ws.blastn.AppServicePortType getAppServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public ciat.cgh.blast.ws.blastn.AppServicePortType getAppServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ciat.cgh.blast.ws.blastn.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.blastn.AppServicePortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ciat.cgh.blast.ws.blastn.AppServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ciat.cgh.blast.ws.blastn.AppServicePortSoapBindingStub _stub = new ciat.cgh.blast.ws.blastn.AppServicePortSoapBindingStub(new java.net.URL(AppServicePort_address), this);
                _stub.setPortName(getAppServicePortWSDDServiceName());
                return _stub;
            }
        }
