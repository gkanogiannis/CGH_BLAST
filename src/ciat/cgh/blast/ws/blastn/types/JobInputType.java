/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastn.types.JobInputType
 *
...
public class JobInputType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastn.types.InputFileType[] inputFile;
    ...
    public JobInputType(
           ...
           ciat.cgh.blast.ws.blastn.types.InputFileType[] inputFile,
     ...
     * @return inputFile
     */
    public ciat.cgh.blast.ws.blastn.types.InputFileType[] getInputFile() {
        return inputFile;
    }
     ...
     * @param inputFile
     */
    public void setInputFile(ciat.cgh.blast.ws.blastn.types.InputFileType[] inputFile) {
        this.inputFile = inputFile;
    }

    public ciat.cgh.blast.ws.blastn.types.InputFileType getInputFile(int i) {
        return this.inputFile[i];
    }

    public void setInputFile(int i, ciat.cgh.blast.ws.blastn.types.InputFileType _value) {
