/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastn.types.JobOutputType
 *
...
public class JobOutputType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastn.types.OutputFileType[] outputFile;
    ...
    public JobOutputType(
           ...
           ciat.cgh.blast.ws.blastn.types.OutputFileType[] outputFile) {
           this.stdOut = stdOut;
           this.stdErr = stdErr;
     ...
     * @return outputFile
     */
    public ciat.cgh.blast.ws.blastn.types.OutputFileType[] getOutputFile() {
        return outputFile;
    }
     ...
     * @param outputFile
     */
    public void setOutputFile(ciat.cgh.blast.ws.blastn.types.OutputFileType[] outputFile) {
        this.outputFile = outputFile;
    }

    public ciat.cgh.blast.ws.blastn.types.OutputFileType getOutputFile(int i) {
        return this.outputFile[i];
    }

    public void setOutputFile(int i, ciat.cgh.blast.ws.blastn.types.OutputFileType _value) {
