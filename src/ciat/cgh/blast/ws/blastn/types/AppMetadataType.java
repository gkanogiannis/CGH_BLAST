/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastn.types.AppMetadataType
 *
...
public class AppMetadataType  implements java.io.Serializable {
    ...
    private ciat.cgh.blast.ws.blastn.types.ArgumentsType types;
    ...
    public AppMetadataType(
           ...
           ciat.cgh.blast.ws.blastn.types.ArgumentsType types,
     ...
     * @return types
     */
    public ciat.cgh.blast.ws.blastn.types.ArgumentsType getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(ciat.cgh.blast.ws.blastn.types.ArgumentsType types) {
        this.types = types;
    }
