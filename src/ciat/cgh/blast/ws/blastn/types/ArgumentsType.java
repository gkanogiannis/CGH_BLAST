/*
 *
 * CGH_BLAST ciat.cgh.blast.ws.blastn.types.ArgumentsType
 *
...
package ciat.cgh.blast.ws.blastn.types;

public class ArgumentsType  implements java.io.Serializable {
    private ciat.cgh.blast.ws.blastn.types.FlagsType[] flags;

    private ciat.cgh.blast.ws.blastn.types.ParamsArrayType taggedParams;

    private ciat.cgh.blast.ws.blastn.types.ParamsArrayType untaggedParams;

    private ciat.cgh.blast.ws.blastn.types.ImplicitParamsType[] implicitParams;

    private ciat.cgh.blast.ws.blastn.types.GroupsType[] groups;

    public ArgumentsType() {
    }

    public ArgumentsType(
           ciat.cgh.blast.ws.blastn.types.FlagsType[] flags,
           ciat.cgh.blast.ws.blastn.types.ParamsArrayType taggedParams,
           ciat.cgh.blast.ws.blastn.types.ParamsArrayType untaggedParams,
           ciat.cgh.blast.ws.blastn.types.ImplicitParamsType[] implicitParams,
           ciat.cgh.blast.ws.blastn.types.GroupsType[] groups) {
           this.flags = flags;
     ...
     * @return flags
     */
    public ciat.cgh.blast.ws.blastn.types.FlagsType[] getFlags() {
        return flags;
    }
     ...
     * @param flags
     */
    public void setFlags(ciat.cgh.blast.ws.blastn.types.FlagsType[] flags) {
        this.flags = flags;
    }
     ...
     * @return taggedParams
     */
    public ciat.cgh.blast.ws.blastn.types.ParamsArrayType getTaggedParams() {
        return taggedParams;
    }
     ...
     * @param taggedParams
     */
    public void setTaggedParams(ciat.cgh.blast.ws.blastn.types.ParamsArrayType taggedParams) {
        this.taggedParams = taggedParams;
    }
     ...
     */
    public ciat.cgh.blast.ws.blastn.types.ParamsArrayType getUntaggedParams() {
        return untaggedParams;
    }
     ...
     */
    public void setUntaggedParams(ciat.cgh.blast.ws.blastn.types.ParamsArrayType untaggedParams) {
        this.untaggedParams = untaggedParams;
    }
     ...
     */
    public ciat.cgh.blast.ws.blastn.types.ImplicitParamsType[] getImplicitParams() {
        return implicitParams;
    }
     ...
     */
    public void setImplicitParams(ciat.cgh.blast.ws.blastn.types.ImplicitParamsType[] implicitParams) {
        this.implicitParams = implicitParams;
    }
     ...
     * @return groups
     */
    public ciat.cgh.blast.ws.blastn.types.GroupsType[] getGroups() {
        return groups;
    }
     ...
     * @param groups
     */
    public void setGroups(ciat.cgh.blast.ws.blastn.types.GroupsType[] groups) {
        this.groups = groups;
    }
